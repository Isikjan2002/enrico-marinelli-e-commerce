      ...
      <div className="sm:ml-12">
        ...
        <div className="form-control max-w-xs">
          ...
          <input
            name="number"
            id="amount"
            className="mt-2 input input-bordered rounded-none input-sm w-full max-w-xs text-accent-content"
            value={amount}
            onChange={(event) =>
        ...
        {/* REMOVE */}
        <button
          className="mt-4 flex items-center gap-2 border p-1 rounded-md"
